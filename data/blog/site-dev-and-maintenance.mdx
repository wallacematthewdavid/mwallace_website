...
Also, you might notice on the nav bar it's called `CV`, and on the layout document it says "Curriculum Vitae". You can of course modify this, but I chose CV since that matches the communications requirement. An exercise you may try: how do I produce this Resume page at `{blogurl}/cv`?
